...
Try {
	...
	[string]$appName = 'QuickTime'
	[string]$appVersion = '7 Uninstaller'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'qttaks,quicktimeplayer' -CloseAppsCountdown 60
		...
		If (Get-InstalledApplication -Name "QuickTime 7") {
			$exitCode = Remove-MSIApplications -Name "QuickTime 7" -PassThru
